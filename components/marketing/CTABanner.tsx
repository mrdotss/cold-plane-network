...
export function CTABanner() {
  return (
    <section className="relative overflow-hidden bg-muted/40 py-20">
      <div className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(ellipse_60%_50%_at_50%_110%,rgba(120,119,198,0.1),transparent)] dark:bg-[radial-gradient(ellipse_60%_50%_at_50%_110%,rgba(120,119,198,0.18),transparent)]" />
